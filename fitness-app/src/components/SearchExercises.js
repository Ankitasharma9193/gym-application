...
const SearchExercises = ({ setExercises, bodyPart, setBodyPart }) => {
  ...
  useEffect(() => { // this is the category which is visible on the page load like cardio etc.
  ...
  const handleSearch = async () => {
    if(search) {
        try {
            ...
            console.log('insearch exercisesData', exercisesData)
            ...
            setSearch('');  // once searched empty input field
